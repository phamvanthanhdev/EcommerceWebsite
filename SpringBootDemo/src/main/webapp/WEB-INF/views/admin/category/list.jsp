      ...
      <div class="container-fluid">
		  ...
		  <c:forEach var="cate"  items="${categories }">
			  <tr>
			      ...
			      <td><img src="/images/${cate.categoryPhoto}" width="120" height="100"></td>
			      <td>${cate.createAt }</td>
			      <td>${cate.updateAt }</td>
			      <td>
			      	<a href="/admin/category/update/${cate.categoryId }" type="button" class="btn btn-primary">Update</a>
			      	<a href="/admin/category/delete/${cate.categoryId }" type="button" class="btn btn-danger">Delete</a>
			      </td>
			    </tr>
		  </c:forEach>

  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form:form action="/admin/category/update" method="POST" modelAttribute="category" enctype="multipart/form-data">
        <form:input path="CategoryId" type="hidden"/>
        <form:input path="CategoryPhoto" type="hidden"/>
        <form:input path="CreateAt" type="hidden"/>
        <form:input path="UpdateAt" type="hidden"/>
		  <div class="form-group">
		    <label for="formGroupExampleInput">Category Name</label>
		    <form:input path="CategoryName" type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter data..."/>
		  	<form:errors path="CategoryName" class="form-text text-danger mb-3"/>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    <img src="/images/${categoryPhoto}" width="300" height="200">
		  </div>
		  <div class="form-group">

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Danh sách hình ảnh sản phẩm</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
      	...
      	<form:form action="/admin/product/savephoto" method="POST" modelAttribute="photo" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
		    <input type="submit" class="btn btn-primary" value="Create New Photo">
		  </div>
		</form:form>
		  ...
		  <tbody>
		  <c:forEach var="pho"  items="${photos }">
			  <tr>
			      <th scope="row">${pho.photoId }</th>
			      <th scope="row">${pho.product.productName }</th>
			      <td><img src="/images/${pho.photoUrl}" width="300" height="255"></td>
			      <td>
			      	<a href="/admin/product/deletephoto/${pho.photoId }?id=${id}" type="button" class="btn btn-danger">Delete</a>
			      </td>
			    </tr>
		  </c:forEach>

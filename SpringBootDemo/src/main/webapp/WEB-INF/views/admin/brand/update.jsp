  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form:form action="/admin/brand/update" method="POST" modelAttribute="brand" enctype="multipart/form-data">
        <form:input path="brandId" type="hidden"/>
        <form:input path="brandPhoto" type="hidden"/>
        ...
        <form:input path="UpdateAt" type="hidden"/>
		  ...
		  <div class="form-group">
		    <img src="/images/${brandPhoto}" width="300" height="200">
		  </div>
		  <div class="form-group">

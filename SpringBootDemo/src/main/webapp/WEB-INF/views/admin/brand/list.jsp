    ...
    <section class="content">
      <div class="container-fluid">
		  ...
		  <c:forEach var="bra"  items="${brands }">
			  <tr>
			      <th scope="row">${bra.brandId }</th>
			      <td>${bra.brandName }</td>
			      <td><img src="/images/${bra.brandPhoto}" width="120" height="100"></td>
			      <td>${bra.createAt }</td>
			      <td>${bra.updateAt }</td>
			      <td>
			      	<a href="/admin/brand/update/${bra.brandId }" type="button" class="btn btn-primary">Update</a>
			      	<a href="/admin/brand/delete/${bra.brandId }" type="button" class="btn btn-danger">Delete</a>
			      </td>
			    </tr>
		  </c:forEach>
